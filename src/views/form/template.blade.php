<div class="form-group" id="template">
        ...
        <div class="row">
            ...
            @endif
                <div class="tab-content">
                    @if (empty($options['categories']))
                        @include ('layout-manager::form.template_add', ['disableAdd' => $options['disableAdd'], 'categories' => [], 'templates' => $options['templates']])
                    @else
                        @foreach($options['categories'] as $key => $cat)
                            @include ('layout-manager::form.template_add', ['disableAdd' => $options['disableAdd'], 'categories' => $options['categories'], 'templates' => $options['templates'], 'key' => $key, 'category' => $cat])
                        @endforeach
                    @endif
                </div>
            </div>
    ...
    <input-modal v-if="panels" ></input-modal><div class="form-group" id="template">
            <div class="col-md-12 text-center" style="">
                <div class="row">
                    @if (empty($options['categories']))
                        <div class="col-md-12 col-sm-12 col-xs-12 sortable {{ (isset($noEdit) && $noEdit === true ? 'no-edit' : '') }}">
...
@include ('layout-manager::form.template_portlet', ['disableAdd' => $options['disableAdd']])
            </script>
